  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        pkgs:
        let
          canRunBuiltBinary = pkgs.stdenv.buildPlatform.canExecute pkgs.stdenv.hostPlatform;
        in
        {
          default = pkgs.buildGoModule {
            ...
            # After go.mod/go.sum change: set to lib.fakeHash, run `nix build`,
            # and paste the real hash from the mismatch error.
            ...
            postInstall = lib.optionalString canRunBuiltBinary ''
